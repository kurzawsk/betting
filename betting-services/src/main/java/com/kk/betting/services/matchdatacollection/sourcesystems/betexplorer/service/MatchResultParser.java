...
public class MatchResultParser extends HtmlParser<Map<String, String[]>> {
    ...
    private static final String PATTERN_MATCH_RESULT_PRE = "^<td class=\"table-matches__[tt].*?$";
        ...
        for (String line : filteredLines) {
            ...
            if (matchValues.length == 3) {
                ...
                if (normalScore.length == 2) {
                    ...
                    result.put(identifier, new String[]{MatchResult.Type.POSTPONED.toString()});
                    ...
                    result.put(identifier, new String[]{MatchResult.Type.CANCELLED.toString()});
                }
            }
        }
